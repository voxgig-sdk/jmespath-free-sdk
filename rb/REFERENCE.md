# JmespathFree Ruby SDK Reference

Complete API reference for the JmespathFree Ruby SDK.
...
#### `JmespathFreeSDK.test(testopts = nil, sdkopts = nil)`
...
| --- | --- | --- | --- |
| `data` | `Object` | Yes | The JSON object or array to transform |
