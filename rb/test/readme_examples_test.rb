...
#      offline in seeded test mode (JmespathFreeSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "JmespathFree_sdk.rb")
  SDK_CLASS = "JmespathFreeSDK"
