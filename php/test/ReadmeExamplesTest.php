...
// JmespathFree SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (JmespathFreeSDK::test)
...
{
    private const SDK_CLASS = 'JmespathFreeSDK';
    ...
    private const SDK_BASE = 'jmespathfree_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../jmespathfree_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
