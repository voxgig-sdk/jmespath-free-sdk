...
// JmespathFree SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = JmespathFreeOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(JmespathFreeOmni::structfix($now, Struct::undef()))
                        !== json_encode(JmespathFreeOmni::structfix($val, Struct::undef()))) {
