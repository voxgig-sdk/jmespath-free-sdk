...
// JmespathFree SDK utility: graphql
//
...
class JmespathFreeGraphql
{
    ...
    // equivalent.
    public static function body(JmespathFreeContext $ctx): mixed
    {
    ...
    public static function errors(JmespathFreeContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
