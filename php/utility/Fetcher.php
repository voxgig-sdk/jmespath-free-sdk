...
// JmespathFree SDK utility: fetcher

class JmespathFreeFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; JmespathFreeSDK/1.0)';
    ...
    public static function call(JmespathFreeContext $ctx, string $fullurl, array $fetchdef): array
    {
