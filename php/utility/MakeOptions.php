...
// JmespathFree SDK utility: make_options

class JmespathFreeMakeOptions
{
    ...
    public static function call(JmespathFreeContext $ctx): array
    {
        ...
        //
        // `JmespathFreeSchema::optspec()` is built from the model:
        ...
        $optspec = JmespathFreeSchema::optspec();
