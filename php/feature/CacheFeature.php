...
// JmespathFree SDK cache feature
...
class JmespathFreeCacheFeature extends JmespathFreeBaseFeature
{
    ...
    private function _through(JmespathFreeContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
