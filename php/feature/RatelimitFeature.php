...
// JmespathFree SDK ratelimit feature
...
class JmespathFreeRatelimitFeature extends JmespathFreeBaseFeature
{
    ...
    private function _acquire(JmespathFreeContext $ctx): void
    {
    ...
    private function _track(JmespathFreeContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
