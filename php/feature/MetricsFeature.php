...
// JmespathFree SDK metrics feature
...
class JmespathFreeMetricsFeature extends JmespathFreeBaseFeature
{
    ...
    private function _record(JmespathFreeContext $ctx, bool $ok): void
    {
