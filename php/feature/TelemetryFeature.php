...
// JmespathFree SDK telemetry feature
...
class JmespathFreeTelemetryFeature extends JmespathFreeBaseFeature
{
    ...
    private function _close(JmespathFreeContext $ctx, bool $ok): void
    {
