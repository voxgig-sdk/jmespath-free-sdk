...
// JmespathFree SDK netsim feature
...
class JmespathFreeNetsimFeature extends JmespathFreeBaseFeature
{
    ...
    private function _simulate(JmespathFreeContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(JmespathFreeContext $ctx, array $applied): void
    {
        $client = $this->client;
