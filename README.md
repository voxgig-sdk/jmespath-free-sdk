...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/jmespath-free` | `npm install @voxgig-sdk/jmespath-free` |
| Python | `voxgig-sdk-jmespath-free` | `pip install voxgig-sdk-jmespath-free` |
| PHP | `voxgig-sdk/jmespath-free` | `composer require voxgig-sdk/jmespath-free` |
| Golang | `github.com/voxgig-sdk/jmespath-free-sdk/go` | `go get github.com/voxgig-sdk/jmespath-free-sdk/go` |
| Ruby | `voxgig-sdk-jmespath-free` | `gem install voxgig-sdk-jmespath-free` |
| Lua | `voxgig-sdk-jmespath-free` | `luarocks install voxgig-sdk-jmespath-free` |
