...
from jmespathfree_sdk.utility import register

# Load features
from jmespathfree_sdk.feature.base_feature import JmespathFreeBaseFeature
from jmespathfree_sdk.features import _has_feature, _make_feature
...
class JmespathFreeSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = JmespathFreeUtility()
        self._utility = utility

        from jmespathfree_sdk.config import shared_config
    ...
    def get_utility(self):
        return JmespathFreeUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("JmespathFreeSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def JmesPath(self, data=None) -> "JmesPathEntity":
        ...
        from jmespathfree_sdk.entity.jmes_path_entity import JmesPathEntity
