...
from jmespathfree_sdk.jmespathfree_types import (
    JmesPath,
    JmesPathCreateData,
)
...
class JmesPathEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return JmesPathEntity(self._client, opts)
    ...
    def create(self, reqdata: JmesPathCreateData, ctrl=None) -> JmesPath:
        utility = self._utility
