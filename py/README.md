...
The SDK exposes the API as capitalised, semantic **Entities** — for example `client.JmesPath()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/jmespath-free-sdk/releases)) or
...
```
py/
├── jmespathfree_sdk.py         -- Main SDK module
