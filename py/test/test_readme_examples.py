# JmespathFree SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions JmespathFreeSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both JmespathFreeSDK(...) and JmespathFreeSDK.test(...) become
#      JmespathFreeSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "jmespathfree_sdk"
_SDK_CLASS = "JmespathFreeSDK"
