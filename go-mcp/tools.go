...
type Args struct {
	Entity string         `json:"entity" jsonschema:"jmes_path"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.JmespathFreeSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "jmespath-free_list",
		Description: "List records from JmespathFree. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "jmespath-free_load",
		Description: "Load a single record from JmespathFree. " +
...
func runOp(client *sdk.JmespathFreeSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.JmespathFreeSDK, name string) (sdk.JmespathFreeEntity, error) {
	switch strings.ToLower(name) {
	case "jmes_path":
		return client.JmesPath(nil), nil
