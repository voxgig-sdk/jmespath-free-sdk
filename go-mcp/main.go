// Command JmespathFree-mcp is an MCP server exposing the JmespathFree
// SDK as MCP tools.
//
// Two tools are registered:
//
//	JmespathFree_list  — list records of an entity
//	JmespathFree_load  — load a single record of an entity
//
