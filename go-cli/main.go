// Command JmespathFree-cli is a CLI + REPL for the JmespathFree SDK,
...
const prompt = "jmespath-free"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "jmes_path"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      JMESPATH_FREE_APIKEY (api key), JMESPATH_FREE_BASE (base url override)")
