...
func registerSDKWords(r *eng.Registry, client *sdk.JmespathFreeSDK) {
...
func runOp(client *sdk.JmespathFreeSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
