...
func NewJmesPathEntity(client *core.JmespathFreeSDK, entopts map[string]any) *JmesPathEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *JmesPathEntity) GetName() string { return e.name }
...
func (e *JmesPathEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *JmesPathEntity) Deleted() bool {
	return e.deleted
}


func (e *JmesPathEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewJmesPathEntity(e.client, opts)
}

func (e *JmesPathEntity) Data(args ...any) any {
...
func (e *JmesPathEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an JmesPath; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *JmesPathEntity) DataTyped(data ...JmesPath) JmesPath {
	if len(data) > 0 {
		return typedFrom[JmesPath](e.Data(asMap(data[0])))
	}
	return typedFrom[JmesPath](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through JmesPath (all fields
// optional at the wire level).
func (e *JmesPathEntity) MatchTyped(match ...JmesPath) JmesPath {
	if len(match) > 0 {
		return typedFrom[JmesPath](e.Match(asMap(match[0])))
	}
	return typedFrom[JmesPath](e.Match())
}
...
func (e *JmesPathEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *JmesPathEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *JmesPathEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *JmesPathEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// JmesPathCreateData and returns an JmesPath. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *JmesPathEntity) CreateTyped(reqdata JmesPathCreateData, ctrl map[string]any) (JmesPath, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return JmesPath{}, err
	}
	return typedFrom[JmesPath](res), nil
}



func (e *JmesPathEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *JmesPathEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *JmesPathEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
