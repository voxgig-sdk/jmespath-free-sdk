...
func (sdk *JmespathFreeSDK) OptionsMap() map[string]any {
...
func (sdk *JmespathFreeSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *JmespathFreeSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *JmespathFreeSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *JmespathFreeSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *JmespathFreeSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *JmespathFreeSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("JmespathFreeSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *JmespathFreeSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *JmespathFreeSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("JmespathFreeSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *JmespathFreeSDK {
	...
	sdk := NewJmespathFreeSDK(sdkopts)
	sdk.Mode = "test"
