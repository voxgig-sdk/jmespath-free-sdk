...
// instead of `sdk.NewJmespathFreeSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *JmespathFreeSDK  { return NewJmespathFreeSDK(nil) }
func Test() *JmespathFreeSDK { return TestSDK(nil, nil) }
