...
function envOverride(m) {
    if ('TRUE' === process.env.JMESPATH_FREE_TEST_LIVE ||
        'TRUE' === process.env.JMESPATH_FREE_TEST_OVERRIDE) {
    ...
    m.JMESPATH_FREE_TEST_EXPLAIN = process.env.JMESPATH_FREE_TEST_EXPLAIN || m.JMESPATH_FREE_TEST_EXPLAIN;
    return m;
}
