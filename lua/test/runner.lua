...
function runner.env_override(m)
  local live = runner.getenv("JMESPATH_FREE_TEST_LIVE")
  local override = runner.getenv("JMESPATH_FREE_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("JMESPATH_FREE_TEST_EXPLAIN")
