...
function runner.env_override(m)
  local live = runner.getenv("JMESPATHFREE_TEST_LIVE")
  local override = runner.getenv("JMESPATHFREE_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("JMESPATHFREE_TEST_EXPLAIN")
