...
|---|---|---|
| `ts/` | @voxgig-sdk/jmespath-free-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/jmespath-free-sdk \
      --repository voxgig-sdk/jmespath-free-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/jmespath-free-sdk` shows it, and
`npm trust revoke @voxgig-sdk/jmespath-free-sdk --id=<id>` removes it.
