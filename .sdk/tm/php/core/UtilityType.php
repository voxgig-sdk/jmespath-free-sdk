...
// JmespathFree SDK utility type

class JmespathFreeUtility
{
    ...
    public static function copy(JmespathFreeUtility $src): JmespathFreeUtility
    {
        $u = new JmespathFreeUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
