...
// JmespathFree SDK streaming feature
...
class JmespathFreeStreamingFeature extends JmespathFreeBaseFeature
{
    ...
    private function _iterate(JmespathFreeResult $result): \Generator
    {
    ...
    private function _streamable(JmespathFreeContext $ctx): bool
    {
