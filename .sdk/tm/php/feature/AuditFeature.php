...
// JmespathFree SDK audit feature
...
class JmespathFreeAuditFeature extends JmespathFreeBaseFeature
{
    ...
    private function _emit(JmespathFreeContext $ctx, string $outcome): void
    {
