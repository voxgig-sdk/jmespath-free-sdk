...
// JmespathFree SDK proxy feature
...
class JmespathFreeProxyFeature extends JmespathFreeBaseFeature
{
    ...
    public function init(JmespathFreeContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (JmespathFreeContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
