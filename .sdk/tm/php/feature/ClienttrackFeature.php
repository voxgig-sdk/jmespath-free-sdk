...
// JmespathFree SDK clienttrack feature
...
class JmespathFreeClienttrackFeature extends JmespathFreeBaseFeature
{
    ...
    public function PostConstruct(JmespathFreeContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'JmespathFree-SDK';
