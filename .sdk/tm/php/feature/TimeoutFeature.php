...
// JmespathFree SDK timeout feature
...
class JmespathFreeTimeoutFeature extends JmespathFreeBaseFeature
{
    ...
    private function _with_timeout(JmespathFreeContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(JmespathFreeContext $_ctx, float $ms): void
    {
        $client = $this->client;
