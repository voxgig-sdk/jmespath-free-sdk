...
// JmespathFree SDK idempotency feature
...
class JmespathFreeIdempotencyFeature extends JmespathFreeBaseFeature
{
    ...
    private function _mutating(JmespathFreeContext $ctx): bool
    {
