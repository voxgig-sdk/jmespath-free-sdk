...
class JmespathFreeRbacFeature extends JmespathFreeBaseFeature
{
    ...
    private function _required(JmespathFreeContext $ctx): ?string
    {
    ...
    private function _reject(JmespathFreeContext $ctx, string $required): void
    {
    ...
    private function _track(JmespathFreeContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
