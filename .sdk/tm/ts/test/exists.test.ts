...
describe('exists', async () => {
  ...
  //
  // JmespathFreeSDK.test() is synchronous — it returns the client, not a promise
  ...
  test('test-mode', () => {
    ...
    equal(testsdk instanceof JmespathFreeSDK, true,
      'JmespathFreeSDK.test() must return a client synchronously')
  })
