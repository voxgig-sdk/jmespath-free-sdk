...
from projectname_sdk.core.control import JmespathFreeControl
...
class JmespathFreeContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, JmespathFreeSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, JmespathFreeResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, JmespathFreeResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return JmespathFreeError(code, msg, self)
